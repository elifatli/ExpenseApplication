<%@ Page Title="Employee Expense Reports" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeExpenseReports.aspx.cs" Inherits="ExpenseApplication.ExpenseApplicationPages.EmployeeExpenseReports" %>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-offset-3">
                                    <asp:RadioButton ID="TemplateMonthly" Text="Monthly" GroupName="TemplateReportExpenseGroup" runat="server" Font-Size="Large" CssClass="col-md-4"
                                        AutoPostBack="true" OnCheckedChanged="TemplateMonthly_CheckedChanged" />
                                    <asp:RadioButton ID="TemplateAnnual" Text="Annual" GroupName="TemplateReportExpenseGroup" runat="server" Font-Size="Large"
                            ...
                            <div class="col-md-offset-3">
                                <asp:CustomValidator ID="CustomValidator" runat="server" Display="Dynamic" ErrorMessage="Please select interval." CssClass="text-danger col-md-5"
                                    ValidationGroup="TemplateReportExpenseGroup" EnableClientScript="false"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="TemplateName" ValidationGroup="TemplateReportExpenseGroup" CssClass="text-danger"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="TemplateExpenseType" ValidationGroup="TemplateReportExpenseGroup" CssClass="text-danger"
                            ...
                            <div class="form-group required" runat="server" id="TemplateMonthSection">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="TemplateMonth" ValidationGroup="TemplateReportExpenseGroup" CssClass="text-danger"
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="TemplateYear" ValidationGroup="TemplateReportExpenseGroup" CssClass="text-danger"
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button runat="server" ID="AddTemplateButton" OnClick="AddTemplateButton_Click" ValidationGroup="TemplateReportExpenseGroup" CssClass="btn btn-info" Text="Add" />
                </div>
            </div>
