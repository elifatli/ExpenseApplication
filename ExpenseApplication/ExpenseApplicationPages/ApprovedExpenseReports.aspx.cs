...
{
    public partial class ApprovedExpenseReports : ExpenseApplicationBasePage

    {
        ...
        private void GetReportData()
        {
            ...
            var reportData = DBHelper.GetStaffReportData(userID, selectedDate, BtnYearRadio.Checked);
